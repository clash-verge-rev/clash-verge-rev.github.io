...
<!-- prettier-ignore -->
!!! tip
    Clash Verge Rev 的代理组图标大小为 **`32 * 32`** 像素，并会为图标添加**圆角样式**。
...
| [Hand-Painted-icon](./icon_sets/Hand-Painted-icon.md) | <a href="https://github.com/Semporia/Hand-Painted-icon" target="_blank"><img src="https://img.shields.io/github/stars/Semporia/Hand-Painted-icon"></a> | `png`    | 手绘彩色图标         | <img src="https://fastly.jsdelivr.net/gh/Semporia/Hand-Painted-icon@master/Google_Suite/Google.png" width="48"/> <img src="https://fastly.jsdelivr.net/gh/Semporia/Hand-Painted-icon@master/Rounded_Rectangle/United_States.png" width="48"/> <img src="https://fastly.jsdelivr.net/gh/Semporia/Hand-Painted-icon@master/Rounded_Rectangle/Taiwan.png" width="48"/>                                            |
...
| <img src="../../assets/icons/microsoft.svg" width="48"/><div>Microsoft</div> | <img src="../../assets/icons/linux.svg" width="48"/><div>Linux</div>             | <img src="../../assets/icons/macos.svg" width="48"/><div>MacOS</div>        | <img src="../../assets/icons/android.svg" width="48"/><div>Android</div>         | <img src="../../assets/icons/apple.svg" width="48"/><div>Apple</div>            | <img src="../../assets/icons/google_play.svg" width="48"/><div>Google Play</div> |
